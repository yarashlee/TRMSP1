window.onload = function () {
    ...
    // ********************* POPULATE TABLE WITH REIMBURSEMENT INFO BY EMPLOYEE ID ***************/
    let xhr2 = new XMLHttpRequest();
    const url2 = "http://localhost:9099/getAllEmployeesByReportsTo";
    xhr2.onreadystatechange = function () {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            eventList.forEach(element => {
                let table = document.getElementById("employeeReportsTo-table");
    ...
    xhr4.onreadystatechange = function () {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            reimbursementListRepostTo.forEach(element => {
                ...
                updateForm.action = "updateNoteDepHead.html"
